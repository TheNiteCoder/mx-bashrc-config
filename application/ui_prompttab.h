...
public:
    ...
    void retranslateUi(QWidget *PromptTab)
    {
        ...
        comboBox_SelectPromptProvider->insertItems(0, QStringList()
         << QApplication::translate("PromptTab", "Fancy Prompt", Q_NULLPTR)
        );
        comboBox_SelectFancyPrompt->clear();
        comboBox_SelectFancyPrompt->insertItems(0, QStringList()
         << QApplication::translate("PromptTab", "Tiny", Q_NULLPTR)
         << QApplication::translate("PromptTab", "Std", Q_NULLPTR)
         << QApplication::translate("PromptTab", "Color", Q_NULLPTR)
         << QApplication::translate("PromptTab", "Gentoo", Q_NULLPTR)
         << QApplication::translate("PromptTab", "Dir", Q_NULLPTR)
         << QApplication::translate("PromptTab", "Med", Q_NULLPTR)
         << QApplication::translate("PromptTab", "Narrow", Q_NULLPTR)
         << QApplication::translate("PromptTab", "Wide", Q_NULLPTR)
         << QApplication::translate("PromptTab", "Fancy", Q_NULLPTR)
         << QApplication::translate("PromptTab", "Zee", Q_NULLPTR)
         << QApplication::translate("PromptTab", "Date", Q_NULLPTR)
         << QApplication::translate("PromptTab", "Curl", Q_NULLPTR)
        );
